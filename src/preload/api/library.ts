...
export const updateSideloadedApps = makeListenerCaller('updateSideloadedApps')
export const setGameMetadataOverride = makeListenerCaller('setGameMetadataOverride')
export const setAllGameOverrides = makeListenerCaller('setAllGameOverrides')
...
export const exportScanLog = makeHandlerInvoker('exportScanLog')
